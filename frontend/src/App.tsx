...
function App() {
  ...
  return (
    <div className=' mt-20 flex flex-col justify-start text-center items-center w-screen h-screen'>
      <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
        <span className="text-transparent bg-clip-text bg-gradient-to-r to-slate-500 from-slate-700">Bcycle madisson stations</span>
      </h1>
